...
//		return new ConcurrentMapCacheManager(); /*Usar o cache apenas em um map não é recomendado para produção, por ser muito simples*/
	...
	public MessageSource messageSource() {
		...
		bundle.setDefaultEncoding("UTF-8"); // http://www.utf8-chartable.de/ codigo de conversao de caracteres do utf8 ("\\u"+codigo)
		return bundle;
	}
