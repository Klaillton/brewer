...
public class VendasController {
	...
	@InitBinder("venda") /*
							 * O binder inicia o validador para todos os metodos, a não ser que seja
							 * adicionado o filtro ("venda"), dessa forma ele valida só os metodos com que
							 * tem a classe "venda" nele
							 */
